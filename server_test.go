...
import (
	...
	pb_testproto "github.com/jon-whit/go-grpc-prometheus/examples/testproto"
...
func (s *ServerInterceptorTestSuite) TestRegisterPresetsStuff() {
	for testID, testCase := range []struct {
		...
		{"grpc_server_handling_seconds_sum", []string{"mwitkow.testproto.TestService", "PingEmpty", "unary", codes.OK.String()}},
		{"grpc_server_handling_seconds_count", []string{"mwitkow.testproto.TestService", "PingList", "server_stream", codes.OK.String()}},
